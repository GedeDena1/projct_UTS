			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Input Program Latihan</h3>
							</div>
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-end">
									<li class="breadcrumb-item"><a href="index.php">Beranda</a></li>
									<li class="breadcrumb-item active" aria-current="page">Input Program Latihan</li>
								</ol>
							</div>
						</div>
					</div>
                                    ...
                                    <form action="proses/proses-prodi.php?aksi=inputprodi" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukkan Kode Program Latihan" required>
                                            </div>
											<div class="mb-3">
												<label for="nama" class="form-label">Nama Program Latihan</label>
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Program Latihan" required>
											</div>
                                        </div>
